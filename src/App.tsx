...
function App() {
  ...
  return (
    <>
      ...
      <Alert type='alert_warning' title='Warning Alert' description={<p>This is an warning Alert. <a href="">link</a> Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>} icon={<TriangleAlert />}/>
    </>
  )
}
